...
/**
 * TabSrcSearch represents the model behind the search form of `backend\models\TabSrc`.
 */
class TabSrcSearch extends MyTabSrc
{
    public $versionId;
    /**
     * {@inheritdoc}
    ...
    public function rules()
    {
        return [
            [['versionId'],'required'],
            [['versionId','id', 'actionId', 'actionType'], 'integer'],
