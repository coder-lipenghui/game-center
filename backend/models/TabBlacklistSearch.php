...
/**
 * TabBlacklistSearch represents the model behind the search form of `backend\models\TabBlacklist`.
 */
class TabBlacklistSearch extends TabBlacklist
{
    /**
     * {@inheritdoc}
     */
